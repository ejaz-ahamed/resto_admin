...
//       yield[
//         for(final data in doc)OrderEntity(orderId: data.uId, location: data.location, time: data.time, ordersItem:[
//           for (final orderItem in data.ordersItem)OrderItemEntity(productId: orderItem.productId, type: , quantity: quantity)
//         ] , orderType: orderType)
//       ]
      ...
      yield [
        for (final data in doc)
          OrderEntity(
            ...
            time: data.time,
            ordersItem: [
              for (final orderItem in data.ordersItem)
                OrderItemEntity(
